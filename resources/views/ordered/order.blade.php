...
<main class="flex-1 p-8 bg-cream min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-dark/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-dark/30 overflow-hidden">
